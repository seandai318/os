...
typedef enum {
	...
	OS_ERROR_INVALID_VALUE,			//error due to unexpected value generated by internal program 		 
	...
	OS_ERROR_EVENT_FAILURE,			//a particular event fails, like diameter CEA's result code is not 2001
